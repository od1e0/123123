...
const rentalItems = [
  ...
  new RentalItem(
    ...
    "Погрузитесь в мир эффективных тренировок с велотренажером Body Style TC545! Этот надежный и стильный тренажер предлагает идеальное сочетание комфорта и функциональности для домашних тренировок. Удобное сиденье с регулировкой по высоте и наклону обеспечивает максимальный комфорт, а широкий диапазон уровней нагрузки позволяет легко адаптировать тренировки под любые цели - от кардио до силовых.",
    [
      "1 месяц - 39 руб.",
    ],
